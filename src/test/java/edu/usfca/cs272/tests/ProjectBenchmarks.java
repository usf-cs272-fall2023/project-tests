...
public class ProjectBenchmarks extends ProjectTests {
	...
	public static final double SLOW_SPEEDUP = 1.1;

	/** Speedup required for good tests. */
	public static final double GOOD_SPEEDUP = 1.5;

	/** Speedup required for fast tests. */
	public static final double FAST_SPEEDUP = 1.7;
